...
public class IidUtilsTest {
    ...
    private InstanceIdentifier WO_KEYS_ID = InstanceIdentifier.create(Interfaces.class)
    ...
    public void testCreateInstanceNonMatchingKey () {
        InstanceIdentifier woKeysIID = InstanceIdentifier.create(Interfaces.class)
                .child(Interface.class);
